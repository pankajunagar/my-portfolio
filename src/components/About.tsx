            ...
            >
              <div className="space-y-6">
                <p className="text-2xl sm:text-3xl text-foreground font-bold leading-tight tracking-tight">
                  ...
                  into seamless digital products. dfgsbggnfndfg nfgndfg
                </p>
              ...
              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                <p>
                  As a Senior Hybrid & Web Specialist, I have architected global
                  systems for enterprise leaders and high-performance mobile
                  apps for elite training platforms.
                </p>
                <p>
                  My philosophy is simple: Technical excellence is the baseline.
                  The real challenge is crafting an experience that feels{" "}
              ...
              {[
                {
                  ...
                  desc: "Shipping production code across the entire stack.",
                  offset: 0,
                },
                {
                  icon: <Smartphone />,
                  title: "Mobile Precision",
                  desc: "Native-feel experiences via Ionic & Capacitor.",
                  offset: 40,
                },
                {
                  icon: <Users />,
                  title: "Team Leadership",
                  desc: "Mentoring teams and architecting high-level vision.",
                  offset: 0,
                },
                {
                  icon: <Zap />,
                  title: "Performance First",
                  desc: "Sub-second load times and efficient data sync.",
                  offset: 40,
                },
              ].map((item, i) => (
                <div
